...
chb7=uicontrol( fig1 , 'Style' , 'popup' , 'position' , [85,210,60,20] , 'String' , 'No|V1|V2|V3');
uicontrol ( fig1 , 'style' , ' text' , 'position', [150,206,60,20] , 'string' , 'Resol.:' ,'horizontalAlignment','left');
chb8=uicontrol( fig1 , 'Style' , 'popup' , 'position' , [200,210,60,20] , 'String' , 'Low|High');
uicontrol ( fig1 , 'style' , ' text' , 'position', [265,206,60,20] , 'string' , 'Levels:' ,'horizontalAlignment','left');
Text26 = uicontrol ( fig1 , 'style' , ' edit' , 'position', [315,210,60,20] , 'string' , '10' );
uicontrol ( fig1 , 'style' , ' text' , 'position', [385,206,120,20] , 'string' , 'Mode:' ,'horizontalAlignment','left');
chb18=uicontrol( fig1 , 'Style' , 'popup' , 'position' , [430,210,60,20] , 'String' , '3 sig.|mud');
...
pb7 = uicontrol ( fig1 , 'style' , 'push' , 'position' , [165 120 120 25] ,'string' , 'Refresh plots' , 'callback' , '[V1,V2,V3,params]=ClearVars(params); [V1,V2,V3,params] = DataFormat(data.filtered,params);[sub1,sub2,sub3,sub6,V1,V2,V3,Vtot,params]=Stereoplot(V1,V2,V3,params,Namein,Pathin,sub1,sub2,sub3,sub6,chb1,chb2,chb3,chb4,chb5,chb6,chb7,chb8,chb9,chb10,chb11,chb12,chb13,chb14,chb15,chb16,chb17,chb18,Text8,Text9,Text10,Text11,Text12,Text13,Text14,Text15,Text16,Text17,Text18,Text19,Text20,Text23,Text24,Text25,Text26);' );
