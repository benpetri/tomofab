function [contours, grid] = DataDens(PointsCart,chb1,chb8,Text26)
%
...
% - A MATLAB routine is available at https://github.com/vollmerf
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
nlevels = str2num(get(Text26,'String')); % Get contours number
sigma = 3.0;
interpparam = 0.2;
