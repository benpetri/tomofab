...
uicontrol ( fig1 , 'style' , ' text' , 'position', [185,206,60,20] , 'string' , 'Interp.:' ,'horizontalAlignment','left');
chb8=uicontrol( fig1 , 'Style' , 'popup' , 'position' , [235,210,100,20] , 'String' , 'None|Cubic');
uicontrol ( fig1 , 'style' , ' text' , 'position', [350,206,120,20] , 'string' , 'Cmap:' ,'horizontalAlignment','left');
chb9=uicontrol( fig1 , 'Style' , 'popup' , 'position' , [400,210,60,20] , 'String' , 'Axis|B & W|Jet|Parula');
