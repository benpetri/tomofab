...
clearvars -except sub1 sub2 sub3 sub4 sub5 sub6 Text1 Text2 Text3 Text4 Text5 Text6 Text7 Text8 Text9 Text10 Text11 Text12 Text13 Text14 Text15 Text16 Text17 Text18 Text19 Text20 Text21 Text22 Text23 Text24 Text25 chb1 chb2 chb3 chb4 chb5 chb6 chb7 chb8 chb9 chb10 chb11 chb12 chb13 chb14 chb15 chb16 chb17
...
fIDin = fopen(filein);
raw=textscan(fIDin,'%f %s %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f','HeaderLines',1,'Delimiter','	');
fclose(fIDin);
...
for i=1:size(raw{1},1)
    if raw{9}(i)~=0 && raw{13}(i)~=0
        if raw{17}(i)~=0 && raw{18}(i)~=0 && raw{19}(i)~=0
            for k = 1:size(raw,2)
...
[sub1,sub2,sub3,sub6,V1,V2,V3,Vtot,params]=Stereoplot(V1,V2,V3,params,Namein,Pathin,sub1,sub2,sub3,sub6,chb1,chb2,chb3,chb4,chb5,chb6,chb7,chb8,chb9,chb10,chb11,chb12,chb13,chb14,chb15,chb16,chb17,Text8,Text9,Text10,Text11,Text12,Text13,Text14,Text15,Text16,Text17,Text18,Text19,Text20,Text23,Text24,Text25);
